...
public class ChatClient extends JFrame implements ActionListener, KeyListener, Runnable {
	...
	public ChatClient() {
		...
		Color c1 = new Color(130, 130, 240);
	...
	public void run() {
		...
		try {
			...
			while(true) {
				...
				jta.append(msg + "\n");		//append는 옆으로 붙여나가므로 개행
				
				JScrollBar bar = jsp.getVerticalScrollBar();	//스크롤바 최대로 설정
	...
	public void keyPressed(KeyEvent e) {
		...
		if(key == KeyEvent.VK_ENTER) {	//엔터를 눌렀을 때
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == jbtn1) {
			...
			layout.show(getContentPane(), "Chat");	//Chat 레이아웃으로 바뀌도록
